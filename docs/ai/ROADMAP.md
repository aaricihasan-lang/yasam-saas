...
| **S2.19-BF/BF-1B→D → BF-2 → S2.19C** | **1B:** production ön kontrol SQL · **1C:** canlı dry-run · **1D:** doğrulama · **BF-2:** write (ayrı hard gate) · **S2.19C:** canlı smoke + INV | ⬜ | Ayrı onay; **otomatik açılmaz**. "Tam güvenli canlı retrieval" S2.19C öncesi ilan edilmez |
