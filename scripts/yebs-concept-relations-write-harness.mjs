...
check("20260907000000 migration mevcut", existsSync(resolve(ROOT, "supabase/migrations/20260907000000_yebs_concept_relation_mutations.sql")));
...
{
  const a5aMig = readFileSync(resolve(ROOT, "supabase/migrations/20260907000000_yebs_concept_relation_mutations.sql"), "utf8").replace(/--.*$/gm, "");
