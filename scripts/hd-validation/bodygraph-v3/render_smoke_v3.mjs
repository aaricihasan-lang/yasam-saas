...
//   2) V3-4: 9 merkez polygon → polygon === 9 && circle === 0 (gate/circle sonraki faz)
//      (circle=N invariant'ı gate eklenince aktifleşir)
...
const errors = [];
console.log("Premium BodyGraph V3 — V3-4 render smoke (7 golden)\n");
...
console.log(`\nCHECK: ${IDS.length}/${IDS.length} golden — PremiumBodyGraphV3 V3-4 render OK (9 merkez: polygon=9, circle=0, meta doğru).`);
