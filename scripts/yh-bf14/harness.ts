...
function privateMemoryMigrationChecks(): void {
  ...
  const a = read("20260929000000_yh_client_index_private_reclassify.sql");
  ...
  const c = read("20260929000100_yh_search_tenant_client_candidates.sql");
  ...
  const e = read("20260929000200_yh_client_cdc_outbox.sql");
