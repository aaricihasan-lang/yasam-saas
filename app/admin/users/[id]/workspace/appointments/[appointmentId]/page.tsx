...
const navLinkClass =
  "inline-flex items-center gap-2 rounded-xl border-2 border-sky-200 bg-sky-50 px-4 py-2.5 text-sm font-black text-sky-950 transition hover:border-sky-300 hover:bg-sky-100 no-underline";
    ...
    <main className="relative min-h-screen overflow-x-hidden bg-[linear-gradient(135deg,#fdf4ff_0%,#eef2ff_42%,#f0fdfa_100%)] text-slate-900 antialiased">
      <div className={pageContainerClass}>
        <nav className="mb-6 flex flex-wrap gap-3" aria-label="Üst navigasyon">
          <Link
            href={`/admin/users/${expertUserId}/workspace/appointments`}
