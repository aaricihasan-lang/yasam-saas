...
import { publishConsultation } from "@/lib/human-design/consultation/admin/consultationAdminService";
import {
...
/** POST: rpc_hd_consultation_publish — DB publish gate kaynak gerçekliğidir. */
export async function POST(req: NextRequest, ctx: RouteContext): Promise<Response> {
  ...
  const r = await publishConsultation(guard.db, guard.adminId, id);
