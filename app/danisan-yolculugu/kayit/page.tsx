  ...
  return (
    <main className="relative min-h-screen w-full overflow-x-hidden bg-[linear-gradient(135deg,#edf5ff_0%,#f7f2ff_45%,#fff3fb_100%)] px-5 py-4 text-slate-900 antialiased sm:px-8 lg:px-10 xl:px-12">
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        <div className="absolute -left-24 -top-24 h-[400px] w-[400px] rounded-full bg-emerald-400/12 blur-[140px]" />
        <div className="absolute -right-20 top-0 h-[360px] w-[360px] rounded-full bg-indigo-400/10 blur-[140px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto w-full max-w-4xl">
        ...
        {/* Header */}
        <header className="relative mb-5 overflow-hidden rounded-2xl border border-white/80 bg-white/85 px-5 py-4 shadow-lg sm:px-6">
          <UserPlus
            className="pointer-events-none absolute right-4 top-1/2 h-20 w-20 -translate-y-1/2 text-emerald-400 opacity-10"
            strokeWidth={1.25}
            aria-hidden
          />
        ...
        {/* Form */}
        <section className="overflow-visible rounded-2xl border border-emerald-200/80 bg-white/80 p-5 shadow-lg backdrop-blur-sm">
          <div className="mb-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <Field label="Burç (Otomatik)">
              <input value={burc} disabled className={`${inputClassName} bg-slate-100 text-slate-700`} />
            </Field>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3">
            ...
            <Link
              ...
              className="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-bold text-slate-700 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
            >
              Listeye Dön
            </Link>
          </div>
          ...
          <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-green-50 p-3 shadow-sm">
              ...
              <p className="mt-1 text-xs font-medium text-slate-600">Verileriniz güvenli şekilde saklanır.</p>
            </div>
            <div className="rounded-xl border border-violet-200 bg-gradient-to-br from-violet-50 via-white to-indigo-50 p-3 shadow-sm">
              ...
              <p className="mt-1 text-xs font-medium text-slate-600">Doğum tarihinden burç otomatik belirlenir.</p>
            </div>
            <div className="rounded-xl border border-cyan-200 bg-gradient-to-br from-cyan-50 via-white to-sky-50 p-3 shadow-sm">
              ...
              <p className="mt-1 text-xs font-medium text-slate-600">Kayıt sonrası detay sayfasına geçebilirsiniz.</p>
            </div>
            <div className="rounded-xl border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-orange-50 p-3 shadow-sm">
              ...
              <p className="mt-1 text-xs font-medium text-slate-600">Kişisel veriler yalnızca yetkili kullanımdadır.</p>
            </div>
          </div>
        </section>
      </div>
