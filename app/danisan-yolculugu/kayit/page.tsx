...
// F7: Burç hesabı paylaşımlı canonical helper'a taşındı (lib/danisan/burc.ts).
// UI yalnız ANLIK GÖSTERİM yapar; nihai/authoritative burç SUNUCUDA (POST/PATCH)
// aynı helper ile türetilir. Boş için "" gösterilir (input alanı boş kalsın).
function burcGoster(date: string): string {
  return computeBurc(date) ?? "";
}
