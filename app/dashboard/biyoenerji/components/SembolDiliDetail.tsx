...
export default function SembolDiliDetail({ id }: { id: string }) {
  ...
  return (
    <div className="w-full min-w-0 max-w-none">
      ...
      <header className="mb-3 rounded-xl border border-emerald-200/50 bg-white/70 p-3 shadow-sm">
        ...
        <div className="mt-2.5 flex flex-wrap gap-1.5 border-t border-slate-200/50 pt-2.5">
          <button
            ...
            className="inline-flex h-7 items-center rounded-md border border-emerald-200 bg-emerald-50 px-2.5 text-[11px] font-semibold text-emerald-800 transition hover:bg-emerald-100"
          >
            Düzenle
          </button>
          <button
