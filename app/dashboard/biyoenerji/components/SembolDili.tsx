...
export default function SembolDili() {
  ...
  async function handleKaydet() {
    ...
    const inserted = data as SymbolViewRecord;
  ...
  return (
    <section className={`${sectionShellClass} ring-emerald-100/35`}>
      ...
      <div className="flex min-h-[min(70vh,640px)] flex-col gap-4 lg:flex-row lg:gap-6">
          ...
          <div className="min-h-0 flex-1 space-y-2 overflow-y-auto pr-0.5">
            {loading ? (
              ...
              <CrudEmptyState
                ...
                subtitle={
                  hasSearch
                    ? "Aramayı güncelleyin veya yeni bir sembol kaydı ekleyin."
        ...
        <div className={`${formGlassPanelClass} order-2 border-emerald-100/35 ring-teal-100/30 lg:order-none`}>
          ...
          <div className="mt-7 flex flex-wrap gap-2 border-t border-emerald-100/45 pt-5">
            ...
            <button
              ...
              className="rounded-xl border border-emerald-200/70 bg-emerald-50/90 px-4 py-2.5 text-[12px] font-black text-emerald-950 shadow-[0_6px_18px_-10px_rgba(5,150,105,0.2)] transition hover:-translate-y-0.5 hover:bg-emerald-100/90 disabled:translate-y-0 disabled:cursor-not-allowed disabled:opacity-45"
            >
              Güncelle
            </button>
            <button
