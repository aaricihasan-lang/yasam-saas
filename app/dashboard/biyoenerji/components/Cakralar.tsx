...
export default function Cakralar() {
  ...
  async function handleKaydet() {
    ...
    const inserted = data as ChakraNoteRecord;
  ...
  return (
    <section className={`${sectionShellClass} ring-orange-100/35`}>
      ...
      <div className="flex min-h-[min(70vh,640px)] flex-col gap-4 lg:flex-row lg:gap-6">
          ...
          <div className="min-h-0 flex-1 space-y-2 overflow-y-auto pr-0.5">
            {loading ? (
              ...
              <CrudEmptyState
                ...
                subtitle={
                  hasSearch
                    ? "Aramayı güncelleyin veya yeni bir çakra notu ekleyin."
        ...
        <div
          className={`${formGlassPanelClass} order-2 min-w-0 w-full flex-[1.15] border-orange-100/40 ring-orange-100/25 transition-[background] duration-300 lg:order-none`}
          style={formBgStyle}
        >
          <p className="mb-4 text-[11px] font-black uppercase tracking-wide text-slate-600">
          ...
          <div className="mt-7 flex flex-wrap gap-2 border-t border-orange-100/45 pt-5">
            ...
            <button
              ...
              className="rounded-xl border border-orange-200/70 bg-orange-50/90 px-4 py-2.5 text-[12px] font-black text-orange-950 shadow-[0_6px_18px_-10px_rgba(234,88,12,0.2)] transition hover:-translate-y-0.5 hover:bg-orange-100/90 disabled:translate-y-0 disabled:cursor-not-allowed disabled:opacity-45"
            >
              Güncelle
            </button>
            <button
