...
const newRecordBtnPremium =
  "inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-fuchsia-600 to-violet-600 px-8 py-4 text-base font-black text-white shadow-[0_12px_32px_rgba(192,38,211,0.28)] transition duration-300 hover:-translate-y-0.5 hover:from-fuchsia-700 hover:to-violet-700 hover:shadow-[0_16px_40px_rgba(139,92,246,0.25)]";
            ...
            {rows.map((row, index) => {
              ...
              return (
                ...
                >
                  {badge ? (
                    <span
                      className={`mb-3 inline-flex w-fit max-w-full items-center gap-2 truncate rounded-full px-3.5 py-1.5 text-xs font-black uppercase tracking-wide ${theme.badge}`}
                    >
                      <span
                  ...
                  <p className="mt-3 line-clamp-3 min-h-[4.5rem] flex-1 text-[16px] leading-relaxed text-slate-800/90">
                    {preview}
                  </p>
