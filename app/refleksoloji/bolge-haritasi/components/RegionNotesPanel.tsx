...
export function RegionNotesPanel({ selectedOrgan }: RegionNotesPanelProps) {
  return (
    <aside className="flex h-full min-h-0 w-full shrink-0 flex-col rounded-[24px] border border-white/90 bg-white/80 p-4 shadow-[0_16px_40px_-18px_rgba(91,33,182,0.2)] ring-1 ring-violet-100/70 backdrop-blur-md lg:w-[340px] lg:p-5">
      ...
      <label className="mt-4 flex min-h-0 flex-1 flex-col">
        ...
        <textarea
          ...
          className="mt-2 min-h-[180px] flex-1 resize-none rounded-xl border border-violet-200/60 bg-violet-50/30 px-3.5 py-3 text-base font-medium leading-relaxed text-slate-700 placeholder:text-slate-400 outline-none lg:min-h-[320px]"
        />
      </label>
